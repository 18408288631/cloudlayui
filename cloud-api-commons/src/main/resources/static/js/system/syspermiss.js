    ...
    layui.use('table', function () {
        ...
        tableIns = table.render({
            ...
            cols: [[
                ...
                , {field: 'permissName', title: '权限名称', align: 'center'}
        ...
        $('#vipQuery').on('click', function () {
            ...
            var permissName = $('#permissName').val();
            table.reload('demos', {
                method: 'post'
                , where: {
                    'roleName': roleName,
...
function updateDate(date) {
    ...
    $("#updatepermissName").val(date.permissName);
    var ctx = "/sysuser/queryRole";
    var str = '';
    $.post(ctx, function (data) {
        for (var i = 0; i < data.length; i++) {
